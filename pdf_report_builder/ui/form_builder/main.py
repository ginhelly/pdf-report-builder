...
###########################################################################
## Class BaseTomeContentsPanel
###########################################################################

class BaseTomeContentsPanel ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        self.text_element_name = wx.TextCtrl( self, wx.ID_ANY, u"Содержание тома", wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_ENTER )
        bSizer24.Add( self.text_element_name, 0, wx.ALL|wx.EXPAND, 5 )
        ...
        self.m_staticText55 = wx.StaticText( self, wx.ID_ANY, u"Путь до генерируемого документа:", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText55.Wrap( -1 )

        bSizer24.Add( self.m_staticText55, 0, wx.ALL, 5 )
        ...
        self.m_staticText56 = wx.StaticText( self, wx.ID_ANY, u"Шаблон для генерации", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText56.Wrap( -1 )

        bSizer24.Add( self.m_staticText56, 0, wx.ALL, 5 )
